...
import { Grid3X3, User, LogOut, ChevronDown } from 'lucide-react'
                ...
                {isProfileMenuOpen && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-50">
                    <Link
                      ...
                      className="block px-4 py-3 font-black text-sm hover:bg-gray-100 border-b-2 border-black"
                    >
                      VIEW PROFILE
                    </Link>
                    <button
          ...
          <div className="mt-4 flex flex-col gap-3 pb-4">
            {isLoggedIn ? (
              <>
                <Link
                  href="/profile"
                  className="w-full px-6 py-3 border-2 border-black font-black text-base bg-green-400 hover:bg-green-300 transition-all duration-200 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transform hover:scale-[0.98] text-center flex items-center justify-center gap-2"
                >
                  <User className="w-4 h-4" />
                  PROFILE
                </Link>
              ...
              <>
                <Link
                  ...
                  className="w-full px-6 py-3 border-2 border-black font-black text-base bg-yellow-400 hover:bg-yellow-300 transition-all duration-200 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transform hover:scale-[0.98] text-center"
                >
                  LOGIN
                </Link>
                <Link
